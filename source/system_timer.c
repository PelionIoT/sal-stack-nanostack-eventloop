...
sys_timer_struct_s * system_timer_free_ptr = NULL;
sys_timer_struct_s * system_timer_list_ptr = NULL;
...
{
	sys_timer_struct_s * cur, *prev = NULL;
	int8_t res=-1;
	platform_enter_critical();
...
{
	sys_timer_struct_s * cur, *temp, *prev = NULL;
	platform_enter_critical();
	//Keep runtime time
